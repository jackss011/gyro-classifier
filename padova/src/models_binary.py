...
class CNN_binary(nn.Module):
    def __init__(self, numClasses, layer_inflation=1, af32=False):
        ...
        self.net = nn.Sequential(
            ...
            BinarizeConv2d(1, infl(32), kernel_size=(1, 9), stride=(1, 2), padding=(0, 4), af32=self.af32),
            ...
            BinarizeConv2d(infl(32), infl(64), kernel_size=(1, 3), stride=1, padding=(0, 1), af32=self.af32),
            nn.BatchNorm2d(infl(64)),
            nn.Hardtanh(inplace=True),

            # Fourth Layer
            BinarizeConv2d(infl(64), 128, kernel_size=(1, 3), stride=1, padding=(0, 1), af32=self.af32),
            nn.BatchNorm2d(128),
            nn.Hardtanh(inplace=True),
