...
python train_ternary.py --dreg "linear" --dmax 0.20  --dmin 0.1
python train_ternary.py --dreg "linear" --dmax 0.20  --dmin 0.01
python train_ternary.py --dreg "linear" --dmax 0.20  --dmin 0.001
python train_ternary.py --dreg "linear" --dmax 0.20  --dmin 0.0001
python train_ternary.py --dreg "linear" --dmax 0.20  --dmin 0.0000
